...
{
public:
	ConstantOptimiser(Dialect const& _dialect, GasMeter const& _meter):
		m_evmVersion(dynamic_cast<EVMDialect const&>(_dialect).evmVersion()),
		m_meter(_meter)
	{}
...
private:
	...
	Representation represent(std::string const& _instruction, Representation const& _arg1, Representation const& _arg2) const;
